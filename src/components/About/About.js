...
class About extends Component {
    render() {
        return(
            <Fragment>
                <div className="moon-gray bg-dark-gray avenir mw10 center ph5-ns pt5">
                    <div className="cf ph2-ns">
                        <div className="fl w-100 pa2">
                        <div className="moon-gray bg-dark-gray">
                            <img className='about_me ba b--black-10' src={aboutpic} alt='about me'></img>
                        </div>
                        </div>
                        <div className="fl w-100 pa2">
                        <div className="moon-gray bg-dark-gray f4-ns">
                            <h2>About Me</h2>
                ...
                <div className="fl w-100 pa2 moon-gray bg-dark-gray f4 pt4">
                    <p>Find My Resume 
